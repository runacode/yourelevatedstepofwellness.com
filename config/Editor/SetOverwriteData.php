...
if (isset($_REQUEST['Json'])) {
    ...
    file_put_contents($OverwritePath,$_REQUEST['Json']);
...
$ConfigItems = array_keys((array)$overwritedata);
...
<script>
    ...
    function LoadJsonEditor(e) {
        ...
        editor.set(<?php echo json_encode($overwritedata); ?>);
        $('.Save').click(SaveJson);
    ...
    function SaveJson() {
        $.ajax({
            'url': 'SetOverwriteData.php?overwrite='+encodeURIComponent('<?php echo $_REQUEST['overwrite']; ?>'),
